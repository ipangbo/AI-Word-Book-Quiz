...
export const ClozeSession: React.FC<ClozeSessionProps> = ({ entries, config, onFinish, onExit }) => {
  ...
  useEffect(() => {
    const container = document.getElementById('cloze-scroll-container');
        ...
        <div className="min-h-full flex flex-col items-center justify-center p-4">
          <AnimatePresence mode="wait">
            {feedback === 'idle' ? (
                ...
                >
                    <div className="w-full bg-white dark:bg-md-surface-container border border-md-surface-container rounded-3xl p-6 md:p-10 mb-6 shadow-sm text-center">
                        {getMaskedSentence()}
                    </div>
