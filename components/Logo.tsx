...
export const Logo: React.FC<LogoProps> = ({ className = "", size = 64 }) => {
  return (
    ...
    >
      ...
      >
        {/* Background - Material 3 Squircle Shape */}
        <rect 
          x="5" y="5" width="90" height="90" rx="28" 
          fill="var(--md-primary-container)" 
        />
        
        {/* Cinema Context: Film Strip Perforations (Top & Bottom) */}
        <g opacity="0.4">
        ...
        {/* Word/Flashcard Element: A central card */}
        <rect 
        ...
        {/* Quiz Element: A Checkmark Badge in the corner */}
        <circle 
          cx="75" cy="30" r="14" 
        ...
        {/* Decorative lines at bottom representing dictionary entry */}
