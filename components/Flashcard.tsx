...
export const Flashcard: React.FC<FlashcardProps> = ({ data, isFlipped, onFlip }) => {
  ...
  return (
    <div className="relative w-full max-w-xl perspective-1000 cursor-pointer group" onClick={onFlip}>
      <motion.div
      ...
      >
        ...
        >
          ...
          {renderSentence()}
          <p className="text-md-outline text-sm mt-4 opacity-60 group-hover:opacity-100 transition-opacity">Tap to reveal</p>
        </div>
        ...
        >
          ...
          <p className="text-lg text-md-on-secondary-container/80 italic mb-4 text-center">
            "{data.translation}"
          </p>
